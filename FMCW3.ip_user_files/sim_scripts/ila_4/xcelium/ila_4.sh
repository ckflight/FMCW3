...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../../../../../../../../tools/2025.2/data/rsb/busdef" +incdir+"../../../../FMCW3.gen/sources_1/ip/ila_4/hdl/verilog" +incdir+"/tools/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../../../../tools/2025.2/data/rsb/busdef" +incdir+"../../../../FMCW3.gen/sources_1/ip/ila_4/hdl/verilog" +incdir+"/tools/2025.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ila_4 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ila_4 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/ck/Desktop/Workspace/FPGA_Workspace/Vivado/FMCW3_100T/FMCW3.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ila_4_sc.so .tmp_log xcelium_lib waves.shm c.obj)
