...
#
# Script generated by Vivado on Sat Sep 13 20:30:36 +03 2025
...
# script info
echo -e "fifo_generator_0.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L fifo_generator_v13_2_13 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_generator_0 xil_defaultlib.fifo_generator_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fifo_generator_0 -key {Behavioral:sim_1:Functional:fifo_generator_0} -tclbatch cmd.tcl -protoinst "protoinst_files/microblaze.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(fifo_generator_v13_2_13)
