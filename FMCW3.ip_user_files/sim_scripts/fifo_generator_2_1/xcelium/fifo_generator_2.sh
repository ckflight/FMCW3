...
#
# Script generated by Vivado on Mon Aug 03 15:11:27 +03 2026
...
#                fifo_generator_2.sh [-rerun]
#                fifo_generator_2.sh [-reset_run]
#                fifo_generator_2.sh [-clean]
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname fifo_generator_v13_2_14 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm fifo_generator_v13_2_14 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "fifo_generator_2.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../../../../../../../../tools/2025.2/data/rsb/busdef" +incdir+"/tools/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../../../../tools/2025.2/data/rsb/busdef" +incdir+"/tools/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work fifo_generator_v13_2_14 $xmvlog_opts +incdir+"../../../../../../../../../../../tools/2025.2/data/rsb/busdef" +incdir+"/tools/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../../../../tools/2025.2/data/rsb/busdef" +incdir+"/tools/2025.2/data/xilinx_vip/include" \
...
Usage: fifo_generator_2.sh [-rerun]\n\
Usage: fifo_generator_2.sh [-reset_run]\n\
Usage: fifo_generator_2.sh [-clean]\n\
