...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L fifo_generator_v13_2_14 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_generator_2 xil_defaultlib.fifo_generator_2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fifo_generator_2 -key {Behavioral:sim_1:Functional:fifo_generator_2} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_9447.protoinst" -protoinst "protoinst_files/microblaze.protoinst" -log simulate.log
}
