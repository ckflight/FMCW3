...
#
# Script generated by Vivado on Thu May 14 19:46:53 +03 2026
...
#
# Usage        : ila_2.sh
#                ila_2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_2.sh [-rerun]
#                ila_2.sh [-reset_run]
#                ila_2.sh [-clean]
#                ila_2.sh [-reset_log]
...
#                script (type 'ila_2.sh -help' for more information).
#
...
# script info
echo -e "ila_2.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../../../../../../../../tools/2025.2/data/rsb/busdef" +incdir+"../../../../FMCW3.gen/sources_1/ip/ila_2_1/hdl/verilog" +incdir+"/tools/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../../../../tools/2025.2/data/rsb/busdef" +incdir+"../../../../FMCW3.gen/sources_1/ip/ila_2_1/hdl/verilog" +incdir+"/tools/2025.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ila_2 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ila_2 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ila_2_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: ila_2.sh [-rerun]\n\
Usage: ila_2.sh [-reset_run]\n\
Usage: ila_2.sh [-clean]\n\
Usage: ila_2.sh [-reset_log]\n\
Usage: ila_2.sh [-keep_index]\n\
