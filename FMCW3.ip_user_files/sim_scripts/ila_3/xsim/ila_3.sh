...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ila_3 xil_defaultlib.ila_3 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ila_3 -key {Behavioral:sim_1:Functional:ila_3} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_9447.protoinst" -protoinst "protoinst_files/microblaze.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ila_3.wdb xsim.dir libdpi.so)
