...
#
# Script generated by Vivado on Mon Aug 03 15:11:24 +03 2026
...
#
# Usage        : ila_3.sh
#                ila_3.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_3.sh [-rerun]
#                ila_3.sh [-reset_run]
#                ila_3.sh [-clean]
#                ila_3.sh [-reset_log]
...
#                script (type 'ila_3.sh -help' for more information).
#
...
# script info
echo -e "ila_3.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_3.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../../../../../../../../tools/2025.2/data/rsb/busdef" +incdir+"../../../../FMCW3.gen/sources_1/ip/ila_3/hdl/verilog" +incdir+"/tools/2025.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../../../../tools/2025.2/data/rsb/busdef" +incdir+"../../../../FMCW3.gen/sources_1/ip/ila_3/hdl/verilog" +incdir+"/tools/2025.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ila_3 xil_defaultlib.glbl -o ila_3_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ila_3_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ila_3_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ila_3_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ila_3.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ila_3.sh [-help]\n\
Usage: ila_3.sh [-step]\n\
Usage: ila_3.sh [-lib_map_path]\n\
Usage: ila_3.sh [-rerun]\n\
Usage: ila_3.sh [-reset_run]\n\
Usage: ila_3.sh [-clean]\n\
Usage: ila_3.sh [-reset_log]\n\
Usage: ila_3.sh [-keep_index]\n\
Usage: ila_3.sh [-noclean_files]\n\n\
