...
#
# Script generated by Vivado on Mon Mar 30 13:10:38 +0300 2026
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_15 -L axi_utils_v2_0_11 -L xbip_pipe_v3_0_11 -L fir_compiler_v7_2_26 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fir_compiler_0 xil_defaultlib.fir_compiler_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fir_compiler_0 -key {Behavioral:sim_1:Functional:fir_compiler_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_9447.protoinst" -protoinst "protoinst_files/microblaze.protoinst" -log simulate.log
}
