...
#
# Script generated by Vivado on Thu Oct 02 16:40:40 +0300 2025
...
# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_21 -L smartconnect_v1_0 -L xilinx_vip"

# set xvhdl options
xvhdl_opts="--incr --relax "

# script info
echo -e "fir_compiler_0.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_14 -L axi_utils_v2_0_10 -L xbip_pipe_v3_0_10 -L fir_compiler_v7_2_24 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fir_compiler_0 xil_defaultlib.fir_compiler_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fir_compiler_0 -key {Behavioral:sim_1:Functional:fir_compiler_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_87ec.protoinst" -protoinst "protoinst_files/microblaze.protoinst" -log simulate.log
}
