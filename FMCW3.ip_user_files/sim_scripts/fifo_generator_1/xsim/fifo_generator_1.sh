...
#
# Script generated by Vivado on Wed Mar 25 15:34:31 +0300 2026
...
#                fifo_generator_1.sh [-rerun]
#                fifo_generator_1.sh [-reset_run]
#                fifo_generator_1.sh [-clean]
...
# script info
echo -e "fifo_generator_1.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L fifo_generator_v13_2_14 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_generator_1 xil_defaultlib.fifo_generator_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fifo_generator_1 -key {Behavioral:sim_1:Functional:fifo_generator_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_9447.protoinst" -protoinst "protoinst_files/microblaze.protoinst" -log simulate.log
}
...
Usage: fifo_generator_1.sh [-rerun]\n\
Usage: fifo_generator_1.sh [-reset_run]\n\
Usage: fifo_generator_1.sh [-clean]\n\
