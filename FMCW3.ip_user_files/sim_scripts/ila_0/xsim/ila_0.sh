...
#
# Script generated by Vivado on Tue Sep 30 15:13:04 +0300 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ila_0 xil_defaultlib.ila_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ila_0 -key {Behavioral:sim_1:Functional:ila_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_87ec.protoinst" -protoinst "protoinst_files/microblaze.protoinst" -log simulate.log
}
