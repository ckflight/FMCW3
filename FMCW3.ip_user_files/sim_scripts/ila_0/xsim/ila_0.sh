...
#
# Script generated by Vivado on Mon Mar 30 13:11:18 +0300 2026
...
simulate()
{
  xsim ila_0 -key {Behavioral:sim_1:Functional:ila_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_9447.protoinst" -protoinst "protoinst_files/microblaze.protoinst" -log simulate.log
}
