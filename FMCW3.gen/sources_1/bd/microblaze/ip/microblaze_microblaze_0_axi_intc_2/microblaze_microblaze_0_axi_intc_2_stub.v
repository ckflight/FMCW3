...
// Command     : write_verilog -force -mode synth_stub -rename_top microblaze_microblaze_0_axi_intc_2 -prefix
//               microblaze_microblaze_0_axi_intc_2_ microblaze_microblaze_0_axi_intc_2_stub.v
...
(* CHECK_LICENSE_TYPE = "microblaze_microblaze_0_axi_intc_2,axi_intc,{}" *) (* core_generation_info = "microblaze_microblaze_0_axi_intc_2,axi_intc,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_intc,x_ipVersion=4.1,x_ipCoreRevision=22,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED,C_FAMILY=artix7,C_INSTANCE=microblaze_microblaze_0_axi_intc_2,C_S_AXI_ADDR_WIDTH=9,C_S_AXI_DATA_WIDTH=32,C_NUM_INTR_INPUTS=2,C_NUM_SW_INTR=0,C_KIND_OF_INTR=0xfffffffc,C_KIND_OF_EDGE=0xffffffff,C_KIND_OF_LVL=0xffffffff,C_ASYNC_INTR=0xFFFFFFFC,C_NUM_SYNC_FF=2,C_ADDR_WIDTH=32,C_IVAR_RESET_VALUE=0x0000000000000010,C_ENABLE_ASYNC=0,C_HAS_IPR=1,C_HAS_SIE=1,C_HAS_CIE=1,C_HAS_IVR=1,C_HAS_ILR=0,C_IRQ_IS_LEVEL=1,C_IRQ_ACTIVE=0x1,C_DISABLE_SYNCHRONIZERS=1,C_MB_CLK_NOT_CONNECTED=1,C_HAS_FAST=1,C_EN_CASCADE_MODE=0,C_CASCADE_MASTER=0}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "axi_intc,Vivado 2025.2" *) 
module microblaze_microblaze_0_axi_intc_2(s_axi_aclk, s_axi_aresetn, s_axi_awaddr, 
