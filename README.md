...
(Important Note: I keep updating the hardware desgin so these images might be different than the original post. Once new hardware is produced i will update other images as well.)
